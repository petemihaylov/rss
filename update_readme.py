...
def render_article_cell(article):
    return f"""<div style="flex:1 0 200px;max-width:250px;min-width:180px;background:#fafafa;border-radius:8px;padding:10px;margin:8px;box-shadow:0 1px 4px rgba(0,0,0,0.06);display:flex;flex-direction:column;align-items:center;">
